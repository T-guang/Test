    ...
    public sealed class SpiceWorkspaceComponentView : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
    {
        ...
        private void BuildSymbolRoot()
        {
            ...
            else
            {
                ...
                CreateReferenceLabel("PositiveReference", data.Kind == SpiceComponentKind.DcCurrentSource ? "P" : data.Kind == SpiceComponentKind.IdealSwitch ? "A" : "+", new Vector2(-62f, 18f));
                CreateReferenceLabel("NegativeReference", data.Kind == SpiceComponentKind.DcCurrentSource ? "N" : data.Kind == SpiceComponentKind.IdealSwitch ? "B" : "-", new Vector2(62f, 18f));
            }
        }
        ...
        private static string DesignatorFor(SpiceWorkspaceComponentData component)
        {
            ...
            var prefix = component.Kind == SpiceComponentKind.DcVoltageSource ? "V" : component.Kind == SpiceComponentKind.DcCurrentSource ? "I" : component.Kind == SpiceComponentKind.IdealSwitch ? "SW" : component.Kind == SpiceComponentKind.Resistor ? "R" : component.Kind == SpiceComponentKind.Capacitor ? "C" : component.Kind == SpiceComponentKind.Inductor ? "L" : "GND";
