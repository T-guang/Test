    ...
    public sealed class SpiceWorkspaceComponentView : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
    {
        ...
        private void BuildSymbolRoot()
        {
            ...
            else
            {
                ...
                CreateReferenceLabel("PositiveReference", data.Kind == SpiceComponentKind.DcCurrentSource ? "P" : data.Kind == SpiceComponentKind.IdealSwitch ? "A" : data.Kind == SpiceComponentKind.SiliconDiode ? "A" : "+", new Vector2(-62f, 18f));
                CreateReferenceLabel("NegativeReference", data.Kind == SpiceComponentKind.DcCurrentSource ? "N" : data.Kind == SpiceComponentKind.IdealSwitch ? "B" : data.Kind == SpiceComponentKind.SiliconDiode ? "K" : "-", new Vector2(62f, 18f));
            }
        }
        ...
        private void BuildSchematicSymbol()
        {
            ...
            switch (data.Kind)
            {
                ...
                case SpiceComponentKind.IdealSwitch:
                    CreateLine(symbol.transform, new Vector2(-34f, 0f), new Vector2(-4f, 0f), 3f);
                    CreateLine(symbol.transform, new Vector2(4f, 0f), new Vector2(34f, 0f), 3f);
                    CreateLine(symbol.transform, new Vector2(-4f, 0f), new Vector2(16f, data.SiValue > 0.5d ? 0f : 16f), 3f);
                    break;
                case SpiceComponentKind.SiliconDiode:
                    CreateLine(symbol.transform, new Vector2(-34f, 0f), new Vector2(-8f, 0f), 3f);
                    CreateLine(symbol.transform, new Vector2(-8f, -16f), new Vector2(-8f, 16f), 3f);
                    CreateLine(symbol.transform, new Vector2(-8f, -16f), new Vector2(12f, 0f), 3f);
                    CreateLine(symbol.transform, new Vector2(-8f, 16f), new Vector2(12f, 0f), 3f);
                    CreateLine(symbol.transform, new Vector2(16f, -18f), new Vector2(16f, 18f), 3f);
                    CreateLine(symbol.transform, new Vector2(16f, 0f), new Vector2(34f, 0f), 3f);
                    break;
