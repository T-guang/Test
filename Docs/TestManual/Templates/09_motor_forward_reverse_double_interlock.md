...
- 模板 ID：motor_forward_reverse_double_interlock
- 分类：工业电路
- 难度：中高级
- 元件数量：9
- 导线数量：34
- 使用的器件类型：AC_ThreePhase_Power；Breaker_3P；Button_Compound_Green_SB；Button_Compound_SB；Button_Stop_NC；Contactor_KM_380V；Fuse_3P；Motor_ThreePhase_380V
- 模板 JSON 路径：Assets/Resources/Blueprints/Templates/motor_forward_reverse_double_interlock_template.json
...
| forward_button_1 | 复合按钮SB(绿) [forward_button_1]（根据实例 ID 推导） | Button_Compound_Green_SB | 复合按钮SB(绿) | -312, -432 | 无模板覆盖参数 |
| fuse_3p_1 | 熔断器3P(FU) [fuse_3p_1]（根据实例 ID 推导） | Fuse_3P | 熔断器3P(FU) | 72, 384 | 额定电流=10A |
| km_forward | 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导） | Contactor_KM_380V | 交流接触器(KM)<br>(380V) | -120, 96 | 额定电压=380V |
| km_reverse | 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导） | Contactor_KM_380V | 交流接触器(KM)<br>(380V) | 264, 96 | 额定电压=380V |
| motor_1 | 三相异步电动机 (380V) [motor_1]（根据实例 ID 推导） | Motor_ThreePhase_380V | 三相异步电动机<br>(380V) | 552, -120 | 额定电压=380V；额定功率=750W；额定电流=1.8A；负载系数=1；旋转方向=0 |
| power_3p_1 | 三相交流电源 [power_3p_1]（根据实例 ID 推导） | AC_ThreePhase_Power | 三相交流电源 | -720, 384 | 相电压=220V；线电压=380V |
| reverse_button_1 | 复合按钮SB(红) [reverse_button_1]（根据实例 ID 推导） | Button_Compound_SB | 复合按钮SB(红) | 96, -432 | 无模板覆盖参数 |
| stop_1 | 停止按钮(NC) [stop_1]（根据实例 ID 推导） | Button_Stop_NC | 停止按钮(NC) | -600, -432 | 无模板覆盖参数 |
...
| W-021 | stop_1 | 12（12） | forward_button_1 | 23（23） | #F21F1F | 停止按钮(NC) [stop_1]（根据实例 ID 推导）.12 → 复合按钮SB(绿) [forward_button_1]（根据实例 ID 推导）.23 |
| W-022 | stop_1 | 12（12） | reverse_button_1 | 23（23） | #F21F1F | 停止按钮(NC) [stop_1]（根据实例 ID 推导）.12 → 复合按钮SB(红) [reverse_button_1]（根据实例 ID 推导）.23 |
| W-023 | forward_button_1 | 24（24） | reverse_button_1 | 11（11） | #F21F1F | 复合按钮SB(绿) [forward_button_1]（根据实例 ID 推导）.24 → 复合按钮SB(红) [reverse_button_1]（根据实例 ID 推导）.11 |
| W-024 | reverse_button_1 | 12（12） | km_reverse | 21（21） | #B91C1C | 复合按钮SB(红) [reverse_button_1]（根据实例 ID 推导）.12 → 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导）.21 |
| W-025 | km_reverse | 22（22） | km_forward | A1（A1） | #B91C1C | 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导）.22 → 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导）.A1 |
| W-026 | km_forward | A2（A2） | power_3p_1 | L2（L2） | #14A640 | 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导）.A2 → 三相交流电源 [power_3p_1]（根据实例 ID 推导）.L2 |
| W-027 | reverse_button_1 | 24（24） | forward_button_1 | 11（11） | #2563EB | 复合按钮SB(红) [reverse_button_1]（根据实例 ID 推导）.24 → 复合按钮SB(绿) [forward_button_1]（根据实例 ID 推导）.11 |
| W-028 | forward_button_1 | 12（12） | km_forward | 21（21） | #2563EB | 复合按钮SB(绿) [forward_button_1]（根据实例 ID 推导）.12 → 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导）.21 |
| W-029 | km_forward | 22（22） | km_reverse | A1（A1） | #2563EB | 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导）.22 → 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导）.A1 |
| W-030 | km_reverse | A2（A2） | power_3p_1 | L2（L2） | #14A640 | 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导）.A2 → 三相交流电源 [power_3p_1]（根据实例 ID 推导）.L2 |
| W-031 | stop_1 | 12（12） | km_forward | 13（13） | #B91C1C | 停止按钮(NC) [stop_1]（根据实例 ID 推导）.12 → 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导）.13 |
| W-032 | km_forward | 14（14） | reverse_button_1 | 11（11） | #B91C1C | 交流接触器(KM) (380V) [km_forward]（根据实例 ID 推导）.14 → 复合按钮SB(红) [reverse_button_1]（根据实例 ID 推导）.11 |
| W-033 | stop_1 | 12（12） | km_reverse | 13（13） | #2563EB | 停止按钮(NC) [stop_1]（根据实例 ID 推导）.12 → 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导）.13 |
| W-034 | km_reverse | 14（14） | forward_button_1 | 11（11） | #2563EB | 交流接触器(KM) (380V) [km_reverse]（根据实例 ID 推导）.14 → 复合按钮SB(绿) [forward_button_1]（根据实例 ID 推导）.11 |
...
| forward_button_1 | Button_Compound_Green_SB | 11、12、23、24 | 无 |
...
| reverse_button_1 | Button_Compound_SB | 11、12、23、24 | 无 |
